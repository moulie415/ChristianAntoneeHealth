                      ...
                      <View
                        ...
                        {props.key === 'ongoing' ? (
                          <View
                            ...
                            <FontAwesome6 iconStyle="solid" name="bolt" color={colors.appWhite} />
                            <Text
                              style={{
          ...
          <View
            ...
            <View style={{marginHorizontal: 20, width: 275}}>
              <Text
                ...
                avatar, steps, calorie and workout streak data will be visible
                to other users. You can opt out at any time through the settings
                screen.
              </Text>
            </View>
          </View>
